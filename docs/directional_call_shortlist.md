# Directional Call Shortlist

This is the next-pass shortlist for improving the gold benchmark with clearer directional labels (`raised`, `lowered`, `maintained`). All rows below point to primary-source investor materials.
...
- They contain explicit direction words in the primary source itself (`raises`, `lowers`, `flat`, `maintains`).
- They reduce dependence on inference from generic outlook ranges.
